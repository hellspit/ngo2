...
function Navbar() {
    ...
    const fetchEvents = async ()=>{
        setIsLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$eventsService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["eventsService"].getUpcomingEvents(0, 10);
            setEvents(data);
            setError(null);
        } catch (err) {
