...
const authService = {
    login: async (credentials)=>{
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_URL"]}/token`, {
            method: 'POST',
            body: formData
        });
        if (!response.ok) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1382b624._.js.map