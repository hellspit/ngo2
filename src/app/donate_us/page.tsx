...
import styles from './styles.module.css';
import Navigation from '@/components/Navigation';
import qrImage from './img1.jpeg'; // QR image
...
export default function DonatePage() {
  ...
  return (
    <>
            ...
            <div className={styles['donate-form-container']}>
              <form onSubmit={handleSubmit} className={styles['donate-form']}>
                ...
                <div className={styles['qr-container']}>
                  ...
                  />
                  <p className={styles['upi-id']}>UPI ID: abcd@ybl</p>
                </div>
                ...
                <div className={styles['account-details']}>
                  ...
                  <p><strong>Account Number:</strong> 44100728234</p>
                  <p><strong>IFSC Code:</strong>SBIN002595</p>
                </div>
              </form>
            </div>
          </div>
      ...
      {/* QR Modal */}
      {showQRModal && (
        <div className={styles['qr-modal']} onClick={() => setShowQRModal(false)}>
          <img
            src={qrImage.src}
            alt="QR Fullscreen"
            className={styles['qr-modal-image']}
          />
          <button
